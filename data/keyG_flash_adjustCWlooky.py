...
try:
    ...
    #########################################
    print('*********Start the trigger and looky.py will loop the background color ********')
    totScans = 0
...
script_copy_name = f"C:\FDML_data\{timestamp}_stimuli_{pulse_heights:.3f}V_adjustCWlooky.txt"
